...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!post) return {};
  return {
    title: `${post.title} | ぷらっとハウス赤坂`,
    description: post.excerpt,
    alternates: {
      canonical: `https://akasaka.plat-house.jp/blog/${slug}`,
    },
  };
}
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="mt-16 bg-gray-900 text-white rounded-2xl p-8 text-center">
        <p className="font-bold text-lg mb-2">ぷらっとハウス赤坂</p>
        <p className="text-gray-400 text-sm mb-6">赤坂駅徒歩4分・赤坂見附駅徒歩7分・民泊・最大4名</p>
        <a
          href="https://beds24.com/booking.php?propid=303536&referer=BookingLink"
