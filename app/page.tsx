      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-lg font-bold text-gray-900">赤坂</h1>
          </div>
      ...
      <main>
        <section className="bg-gray-50 py-20 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-sm text-gray-500 mb-3">Akasaka · Tokyo</p>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-6">{hotel.catchcopy.ja}</h2>
            <p className="text-gray-600 text-lg mb-4">赤坂駅（東京メトロ千代田線）徒歩4分。40㎡の1DK戸建て一棟貸切・最大4名の民泊。</p>
            <p className="text-gray-500 text-base mb-8">Emma Premium 2キングベッド×2・Netflix・Nintendo Switch・キッチン完備。赤坂・六本木観光・グループ旅行の拠点に最適。</p>
        ...
        <section className="py-10 px-4 bg-white border-b border-gray-100">
          <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="p-4"><p className="text-3xl font-bold text-gray-900">40㎡</p><p className="text-sm text-gray-500 mt-1">1DK戸建て一棟貸切</p></div>
            ...
            <div className="p-4"><p className="text-3xl font-bold text-gray-900">徒歩4分</p><p className="text-sm text-gray-500 mt-1">赤坂駅</p></div>
            <div className="p-4"><p className="text-3xl font-bold text-gray-900">赤坂・港区</p><p className="text-sm text-gray-500 mt-1">六本木すぐ</p></div>
          </div>
        </section>
        ...
        <section id="rooms" className="py-14 px-4 bg-gray-50">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-gray-500 mb-10">40㎡の1DK戸建て一棟貸切。最大4名。</p>
        ...
        {latestPosts.length > 0 && (
          <section className="py-14 px-4 bg-white">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-center text-gray-500 mb-10">赤坂・港区エリアの最新情報</p>
        ...
        <section id="booking" className="py-20 px-4 bg-gray-900 text-white">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl font-bold mb-3">赤坂駅4分。40㎡1DK戸建て一棟貸切・最大4名で赤坂エリアを満喫</h2>
